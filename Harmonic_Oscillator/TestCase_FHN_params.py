...
upper_limit       = 1
omega_min         = 0.0                                      # minimum value of omega
omega_max         = upper_limit                              # maximum value of omega
...
normalization = {
    ...
    'input_parameters': {
        'omega': {'min': omega_min, 'max': omega_max},
    },
...
seed = 0
x0_train, training_target, omega_train = utils.generate_dataset(NTrain, normalization, t_max, dt_num, seed)

# Generating testing dataset
seed = 10
x0_test, testing_target, omega_test = utils.generate_dataset(NTest, normalization, t_max, dt_num, seed)

# Generating extended testing dataset
seed = 20
x0_test_ext, testing_target_ext, omega_test_ext = utils.generate_dataset(NTest_ext, normalization, t_max_ext, dt_num, seed)
...
inp_params_train       = omega_train[:,0,:]
inp_params_test        = omega_test[:,0,:]
inp_params_test_ext    = omega_test_ext[:,0,:]
